...
class DobotSerialInterface(object):
    ...
    def _send_absolute_command(self, cartesian, p1, p2, p3, p4,isGrab, move_mode):
        # global cmd_str_10
        cmd_str_10 = [0]*10
    ...
    def send_absolute_position(self, x, y, z, rot, isGrab=False, move_mode=MOVE_MODE_JOINTS):
        print "sending position %f %f %f" % (x, y, z)
        self._send_absolute_command(True, x, y, z, rot, isGrab, move_mode)

    def setJointPositions(self, base, rear, front, rot,  isGrab=False):
        self.send_absolute_angles(base, rear, front, rot, isGrab)


    def send_absolute_angles(self, base, rear, front, rot, isGrab, move_mode=MOVE_MODE_JOINTS):
        # todo: assertions for ranges
        self._send_absolute_command(False, base, rear, front, rot, isGrab, move_mode)
...
def main():    
    ...
    my_dobot = DobotSerialInterface('COM4')
